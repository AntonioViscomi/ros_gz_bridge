...
void createTestMsg(asv_interfaces::msg::GPSVelocity & _msg)
{
  std_msgs::msg::Header header_msg;
  createTestMsg(header_msg);

  _msg.header = header_msg;
  _msg.velocity_east = 0.00;
  _msg.velocity_north = 0.00;
  _msg.velocity_up = 0.00;

}

void compareTestMsg(const std::shared_ptr<asv_interfaces::msg::GPSVelocity> & _msg)
{
  asv_interfaces::msg::GPSVelocity expected_msg;
  createTestMsg(expected_msg);
